...
from backend.transactions.routes import router as transactions_router # New import
...
import backend.transactions.models # New import
...
app.include_router(transactions_router, prefix="/transactions", tags=["transactions"]) # New router
